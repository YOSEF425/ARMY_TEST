    ...
    return(
       <>
            <div className="allPosts">
                    ...
                    <Post2 name="yosef" url="https://www.bing.com/th/id/OIP.91pMvmfMZ3vVNLrgIYrAvgAAAA?w=120&h=108&c=7&bgcl=e66079&r=0&o=6&dpr=1.3&pid=13.1" description="The nicest snow!"/>
            </div>
       </>
    )
}